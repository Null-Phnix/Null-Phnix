...
I build autonomous AI agents and local LLM infrastructure. Everything runs on my hardware.
...
- **Research tools** — crawlers, corpus builders, data pipelines for AI training
